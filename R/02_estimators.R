...
## 02_estimators.R
##
## Estimators for the longitudinal HIV DTR positivity simulation study.
##
## Primary estimand: RR = E[Y^d1] / E[Y^d2]
...
##
## Primary-analysis conventions:
##   * treatment probabilities are bounded at 0.01 and 0.99 at stochastic nodes;
##   * deterministic post-switch probabilities remain exactly 1;
##   * no additional percentile truncation is applied to final primary IPTW weights;
##   * G-computation, AIPTW and TMLE share the fitted viral-load transition engine;
##   * IPTW, AIPTW and TMLE share the estimated treatment probabilities.
##
## The exact frozen estimator snapshot is preserved in
## archive/estimators_rr_v7_FROZEN.R. The executable statements in this public
## file are unchanged; only release-oriented comments were cleaned.
## ============================================================================
...
## Locked Monte Carlo truth used for bias, MSE and coverage calculations.
## These are ratio-of-marginal-risk truth values from the final analysis.
TRUE_RR    <- 1.469604947
